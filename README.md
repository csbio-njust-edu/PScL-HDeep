# PScL-HDeep
The code is the implementation of our method described in the paper “ Matee Ullah, Ke Han, Fazal Hadi, Jian Xu, Jiangning Song, Dong-Jun Yu, PScL-HDeep: image-based prediction of protein subcellular location in human tissue using ensemble learning of handcrafted and deep features with two-layer feature selection”.
## (I)	data
